      ...
      <div className="mapBox">
        <svg width="959" height="593">
          ...
          <path
            onClick={() => {
              console.log(15);
              getStateById(15).then(() => {
                history.push(`/state/${15}`);
              });
            }}
            className="state"
            id="HI"
          ...
          <path
            onClick={() => {
              console.log(12);
              getStateById(12).then(() => {
                history.push(`/state/${12}`);
              });
            }}
            className="state"
            id="FL"
          ...
          <path
            onClick={() => {
              console.log(13);
              getStateById(13).then(() => {
                history.push(`/state/${13}`);
              });
            }}
            className="state"
            id="GA"
          ...
          <path
            onClick={() => {
              console.log(19);
              getStateById(19).then(() => {
                history.push(`/state/${19}`);
              });
            }}
            className="state"
            id="IA"
          ...
          <path
            onClick={() => {
              console.log(16);
              getStateById(16).then(() => {
                history.push(`/state/${16}`);
              });
            }}
            className="state"
            id="ID"
          ...
          <path
            onClick={() => {
              console.log(17);
              getStateById(17).then(() => {
                history.push(`/state/${17}`);
              });
            }}
            className="state"
            id="IL"
          ...
          <path
            onClick={() => {
              console.log(18);
              getStateById(18).then(() => {
                history.push(`/state/${18}`);
              });
            }}
            className="state"
            id="IN"
          ...
          <path
            onClick={() => {
              console.log(21);
              getStateById(21).then(() => {
                history.push(`/state/${21}`);
              });
            }}
            className="state"
            id="KY"
          ...
          <path
            onClick={() => {
              console.log(22);
              getStateById(22).then(() => {
                history.push(`/state/${22}`);
              });
            }}
            className="state"
            id="LA"
          ...
          <path
            onClick={() => {
              console.log(26);
              getStateById(26).then(() => {
                history.push(`/state/${26}`);
              });
            }}
            className="state"
            id="MA"
          ...
          <path
            onClick={() => {
              console.log(25);
              getStateById(25).then(() => {
                history.push(`/state/${25}`);
              });
            }}
            className="state"
            id="MD"
          ...
          <path
            onClick={() => {
              console.log(23);
              getStateById(23).then(() => {
                history.push(`/state/${23}`);
              });
            }}
            className="state"
            id="ME"
          ...
          <path
            onClick={() => {
              console.log(27);
              getStateById(27).then(() => {
                history.push(`/state/${27}`);
              });
            }}
            className="state"
            id="MI"
          ...
          <path
            onClick={() => {
              console.log(28);
              getStateById(28).then(() => {
                history.push(`/state/${28}`);
              });
            }}
            className="state"
            id="MN"
          ...
          <path
            onClick={() => {
              console.log(29);
              getStateById(29).then(() => {
                history.push(`/state/${29}`);
              });
            }}
            className="state"
            id="MS"
          ...
          <path
            onClick={() => {
              console.log(31);
              getStateById(31).then(() => {
                history.push(`/state/${31}`);
              });
            }}
            className="state"
            id="MT"
          ...
          <path
            onClick={() => {
              console.log(38);
              getStateById(38).then(() => {
                history.push(`/state/${38}`);
              });
            }}
            className="state"
            id="NC"
          ...
          <path
            onClick={() => {
              console.log(39);
              getStateById(39).then(() => {
                history.push(`/state/${39}`);
              });
            }}
            className="state"
            id="ND"
          ...
          <path
            onClick={() => {
              console.log(32);
              getStateById(32).then(() => {
                history.push(`/state/${32}`);
              });
            }}
            className="state"
            id="NE"
          ...
          <path
            onClick={() => {
              console.log(34);
              getStateById(34).then(() => {
                history.push(`/state/${34}`);
              });
            }}
            className="state"
            id="NH"
          ...
          <path
            onClick={() => {
              console.log(35);
              getStateById(35).then(() => {
                history.push(`/state/${35}`);
              });
            }}
            className="state"
            id="NJ"
          ...
          <path
            onClick={() => {
              console.log(36);
              getStateById(36).then(() => {
                history.push(`/state/${36}`);
              });
            }}
            className="state"
            id="NM"
          ...
          <path
            onClick={() => {
              console.log(33);
              getStateById(33).then(() => {
                history.push(`/state/${33}`);
              });
            }}
            className="state"
            id="NV"
          ...
          <path
            onClick={() => {
              console.log(37);
              getStateById(37).then(() => {
                history.push(`/state/${37}`);
              });
            }}
            className="state"
            id="NY"
          ...
          <path
            onClick={() => {
              console.log(41);
              getStateById(41).then(() => {
                history.push(`/state/${41}`);
              });
            }}
            className="state"
            id="OH"
          ...
          <path
            onClick={() => {
              console.log(43);
              getStateById(43).then(() => {
                history.push(`/state/${43}`);
              });
            }}
            className="state"
            id="OR"
          ...
          <path
            onClick={() => {
              console.log(45);
              getStateById(45).then(() => {
                history.push(`/state/${45}`);
              });
            }}
            className="state"
            id="PA"
          ...
          <path
            onClick={() => {
              console.log(47);
              getStateById(47).then(() => {
                history.push(`/state/${47}`);
              });
            }}
            className="state"
            id="RI"
          ...
          <path
            onClick={() => {
              console.log(48);
              getStateById(48).then(() => {
                history.push(`/state/${48}`);
              });
            }}
            className="state"
            id="SC"
          ...
          <path
            onClick={() => {
              console.log(49);
              getStateById(49).then(() => {
                history.push(`/state/${49}`);
              });
            }}
            className="state"
            id="SD"
          ...
          <path
            onClick={() => {
              getStateById(50).then(() => {
                history.push(`/state/${50}`);
              });
            }}
            className="state"
            id="TN"
          ...
          <path
            ...
            id="TX"
            onClick={() => {
              getStateById(51).then(() => {
                history.push(`/state/${51}`);
              });
            }}
          ...
          <path
            onClick={() => {
              console.log(52);
              getStateById(52).then(() => {
                history.push(`/state/${52}`);
              });
            }}
            className="state"
            id="UT"
          ...
          <path
            onClick={() => {
              console.log(55);
              getStateById(55).then(() => {
                history.push(`/state/${55}`);
              });
            }}
            className="state"
            id="VA"
          ...
          <path
            onClick={() => {
              console.log(53);
              getStateById(53).then(() => {
                history.push(`/state/${53}`);
              });
            }}
            className="state"
            id="VT"
          ...
          <path
            onClick={() => {
              console.log(56);
              getStateById(56).then(() => {
                history.push(`/state/${56}`);
              });
            }}
            className="state"
            id="WA"
          ...
          <path
            onClick={() => {
              console.log(58);
              getStateById(58).then(() => {
                history.push(`/state/${58}`);
              });
            }}
            className="state"
            id="WI"
          ...
          <path
            onClick={() => {
              console.log(57);
              getStateById(57).then(() => {
                history.push(`/state/${57}`);
              });
            }}
            className="state"
            id="WV"
          ...
          <path
            onClick={() => {
              console.log(59);
              getStateById(59).then(() => {
                history.push(`/state/${59}`);
              });
            }}
            className="state"
            id="WY"
